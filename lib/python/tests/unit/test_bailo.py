...
# def test_pki_auth_uses_requests_pki(pki_config):
#     bailo = Bailo(pki_config)
#     assert isinstance(bailo.api, RequestsApi)
#     assert bailo.api._requests_module is requests_pkcs12


# def test_null_auth_uses_requests(null_config):
#     bailo = Bailo(null_config)
#     assert isinstance(bailo.api, RequestsApi)
#     assert bailo.api._requests_module is requests


# def test_cognito_auth_uses_requests(cognito_config):
#     bailo = Bailo(cognito_config)
#     assert isinstance(bailo.api, RequestsApi)
#     assert bailo.api._requests_module is requests
...
@pytest.fixture()
def bailo_client(null_config):
    # auth = MockAuthentication()
    # mock_create_client.return_value = config, auth

    return Bailo(null_config)
...
#     mock_cognito_client, cognito_config
# ):
#     cognito_properties = (
#         "user_pool_id",
#         "client_id",
...
#     mock_client_connect, mock_client_init, mock_get_pass, pki_config
# ):
#     bailo = Bailo(pki_config)
