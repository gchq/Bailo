...
def test_create_get_from_version_update_and_delete_release(version: Version | str, model_card_version: float, notes: str, files: list[str], images: list[str], minor: bool, draft: bool, integration_client, example_model):
    # Create release
    release = Release.create(client=integration_client,
