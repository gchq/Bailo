...
const { readFileSync, writeFileSync, readdirSync, mkdir } = require('fs')
...
async function run() {
  ...
  mkdir('./public/docs/api', { recursive: true }, function (err) {
    if (err) console.log(err)
  })
  cp('../../backend/openapi-specs/swagger-v2.json', './public/docs/api/')
  cp('../../backend/openapi-specs/swagger-v3.json', './public/docs/api/')
  cp('./node_modules/swagger-ui-dist/swagger-ui-bundle.js', './public/docs/api/')
  cp('./node_modules/swagger-ui-dist/swagger-ui-standalone-preset.js', './public/docs/api/')
  cp('./node_modules/swagger-ui-dist/swagger-ui.css', './public/docs/api/')
  cp('./node_modules/swagger-ui-dist/index.css', './public/docs/api/')
  cp('./node_modules/swagger-ui-dist/favicon-16x16.png', './public/docs/api/')
  cp('./node_modules/swagger-ui-dist/favicon-32x32.png', './public/docs/api/')
  cp('./public-static/docs/api/index.html', './public/docs/api/')
}
