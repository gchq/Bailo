...
const { readFileSync, writeFileSync, readdirSync, mkdir, mkdirSync } = require('fs')
...
async function run() {
  ...
  cp('../../backend/openapi-specs/swagger-v3.json', './public/api/docs/')
  // see https://swagger.io/docs/open-source-tools/swagger-ui/usage/installation/#static-files-without-http-or-html
  cp('./node_modules/swagger-ui-dist/swagger-ui-bundle.js', './public/api/docs/')
  cp('./node_modules/swagger-ui-dist/swagger-ui-standalone-preset.js', './public/api/docs/')
  cp('./node_modules/swagger-ui-dist/swagger-ui.css', './public/api/docs/')
  cp('./node_modules/swagger-ui-dist/index.css', './public/api/docs/')
  cp('./node_modules/swagger-ui-dist/favicon-16x16.png', './public/api/docs/')
  cp('./node_modules/swagger-ui-dist/favicon-32x32.png', './public/api/docs/')
  cp('./public-static/api/docs/index.html', './public/api/docs/')
}
