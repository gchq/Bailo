        ...
        >
          ...
          >
            ...
            <Typography variant="h5" sx={{ color: "white" }}>
              Making it easy to compliantly manage the machine learning
              lifecycle
            </Typography>
          </Stack>
          <Stack
            ...
            <Box sx={{ px: 10, py: 4, textAlign: "center", height: "100%" }}>
              ...
              >
                <Typography variant="h6">
                  Provides a centralised repository of ML models, where possible
                  with models in standard formats
                </Typography>
                <Typography variant="h6">
                  Enables users to find existing ML models, encouraging re-use
                  of best practice and avoiding duplication of work
                </Typography>
                <Typography variant="h6">
                  Ensures any deployed models are fully compliant, and that
                  compliance rules are applied consistently from a single
                  service
                </Typography>
              </Stack>
            </Box>
