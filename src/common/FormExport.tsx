...
const FormExport = ({
  ...
  const exportElement = () => {
    if (formData?.highLevelDetails?.name !== undefined || 
      formData.highLevelDetails.name !== '') {
    ...
    <>
      ...
      >
        <DialogTitle id="scroll-dialog-title">
          Form data for {
            formData?.highLevelDetails?.name !== undefined 
            ? formData.highLevelDetails.name
            : ''
          }
        </DialogTitle>
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={exportElement}>Download</Button>
        </DialogActions>
      </Dialog>
    </>
  )
