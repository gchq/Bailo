...
export default function SchemaDesigner({
  ...
  setUserSchema: Dispatch<SetStateAction<Schema | undefined>>
}) {
      ...
      pages.forEach((page) => {
        ...
        if (page.questions && page.questions.length > 0) {
          page.questions.forEach((question) => {
            ...
            delete questionToAdd[question.reference].reference
            Object.assign(pageToAdd[page.reference].properties, questionToAdd)
          })
        }
  ...
  }, [schemaDetails, pages, setUserSchema])
