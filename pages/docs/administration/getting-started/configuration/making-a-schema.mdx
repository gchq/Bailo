...
in order dynamically create its upload & deployment forms. These forms can be constructed of various existing widgets,
or even use custom widgets defined in Bailo.
...
application needs in order to run as these fields are hard-coded in various places in the source code.
