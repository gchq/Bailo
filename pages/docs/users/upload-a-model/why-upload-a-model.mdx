...
technical reviewer. Uploaded models do not become visible to users until they have passed both this technical
review and a subsequent review by a senior responsible officer. The technical review assesses the technical aspects of
the model whilst the policy review assesses the suitability of the model with respect to mission objectives, as well as the
manner in which the model developer has addressed legal requirements and adhered to policy guidelines.

Although the policy review includes a legal and other assessments, this approval cannot be regarded as permanent and needs
