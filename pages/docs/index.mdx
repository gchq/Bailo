...
<Box sx={{ flexGrow: 1 }}>
  <Grid container spacing={2}>
    ...
    <Grid item xs={12} lg={4}>
      <IntroCard title='Model Deployments' user='for model consumers' url='./docs/users/upload-a-model'>
        Use Bailo's registry, or code stores to deploy your models to other systems.
      </IntroCard>
    </Grid>
    <Grid item xs={12} lg={4}>
      <IntroCard title='Approvals' user='for accreditors' url='./docs/users/approvals/model-approvals'>
        A guide on how to review models on Bailo for ethical and technical assurance.
      </IntroCard>
    </Grid>
    <Grid item xs={12} lg={4}>
      <IntroCard title='Automation' user='for developers' url='./docs/users/upload-a-model'>
        Bored of doing repetitive actions, use our API or libraries.
      </IntroCard>
    </Grid>
    <Grid item xs={12} lg={4}>
      <IntroCard title='Manage Bailo' user='for administrators' url='./docs/users/upload-a-model'>
        We've tried to make hosting Bailo easy, but documentation is always required.
      </IntroCard>
    </Grid>
    <Grid item xs={12} lg={4}>
      <IntroCard title='Bailo Development' user='for engineers' url='./docs/developers'>
