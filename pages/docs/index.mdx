...
<Box sx={{ flexGrow: 1 }}>
  <Grid container spacing={2}>
    ...
    <Grid item xs={12} lg={4}>
      <IntroCard title='Model Deployments' user='for model consumers' url='./docs/users/deployments'>
    ...
    <Grid item xs={12} lg={4}>
      <IntroCard title='Automation' user='for developers' url='./docs/users/automation'>
        Bored of doing repetitive actions, use our API or libraries.
      </IntroCard>
    </Grid>
    <Grid item xs={12} lg={4}>
      <IntroCard title='Manage Bailo' user='for administrators' url='./docs/administration'>
