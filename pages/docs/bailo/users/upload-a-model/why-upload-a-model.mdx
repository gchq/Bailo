...
uploaded models to pass both a technical review and an assessment by a senior responsible officer (SRO) with respect to
...
technical reviewer (MTR). Uploaded models do not become visible to users until they have passed both this technical
review and a subsequent review by a senior responsible officer (SRO). The MTR review assesses the technical aspects of
the model whilst the SRO review assesses the suitability of the model with respect to mission objectives, as well as the
manner in which the model developer has addressed legal requirements and adhered to policy guidelines.

Although the SRO review includes a legal and policy assessment, this approval cannot be regarded as permanent and needs
to be repeated. The frequency of these subsequent reviews is dependent upon many factors, such as the volatility of the
data on which the model acts or changes in the operational environment.
