...
<Box sx={{ flexGrow: 1 }}>
  <Grid container spacing={2}>
    ...
    <Grid sm={12} md={12} lg={4}>
      <IntroCard title='Model Deployments' user='for model consumers' url='./users/upload-a-model'>
        Use Bailo's registry, or code stores to deploy your models to other systems.
      </IntroCard>
    </Grid>
    <Grid sm={12} md={12} lg={4}>
      <IntroCard title='Approvals' user='for accreditors' url='./users/upload-a-model'>
        A guide on how to review models on Bailo for ethical and technical assurance.
      </IntroCard>
    </Grid>
    <Grid sm={12} md={12} lg={4}>
      <IntroCard title='Automation' user='for developers' url='./users/upload-a-model'>
        Bored of doing repetitive actions, use our API or libraries.
      </IntroCard>
    </Grid>
    <Grid sm={12} md={12} lg={4}>
      <IntroCard title='Manage Bailo' user='for administrators' url='./users/upload-a-model'>
        We've tried to make hosting Bailo easy, but documentation is always required.
      </IntroCard>
    </Grid>
    <Grid sm={12} md={12} lg={4}>
      <IntroCard title='Bailo Development' user='for engineers' url='./users/upload-a-model'>
