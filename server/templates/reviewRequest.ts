...
export function html({ document, requestType }: ReviewRequestContext) {
  ...
  const requestUrl = requestType === 'Upload' ? 
    `${base}/model/${document.model.uuid}` : `${base}/deployment/${document.uuid}`
  ...
  return mjml2html(wrapper(`
    ...
    <mj-section background-color="#356cc7" padding-bottom="15px">
      <mj-column>
        ...
        <mj-text align="center" color="#FFF" font-size="13px" font-family="Helvetica" padding-left="25px" padding-right="25px" padding-bottom="20px" padding-top="10px">${document.model.currentMetadata.highLevelDetails.name}</mj-text>
      </mj-column>
      <mj-column>
      ...
      <mj-column>
        ...
        <mj-text align="center" color="#FFF" font-size="13px" font-family="Helvetica" padding-left="25px" padding-right="25px" padding-bottom="20px" padding-top="10px">${uploader ?? requester}</mj-text>
      </mj-column>
    </mj-section>
