...
import SettingsProfileTab from '../../src/settings/beta/SettingsProfileTab'
import ThemeTab from '../../src/settings/beta/ThemeTab'
    ...
    <Wrapper title='Settings' page='settings'>
      <Box sx={{ bgcolor: 'background.paper' }}>
        ...
        <TabPanel value={tab} index={1}>
          {currentUser && !isCurrentUserLoading && <ThemeTab user={currentUser} />}
        </TabPanel>
      </Box>
    </Wrapper>
  )
