...
`http://localhost:8333` and its administration panel through NGINX on `http://localhost:23646`.
...
docker run --rm -p 4318:8080 -p 23646:23646 --network dev_internal --name second-bailo second-bailo:latest
```
