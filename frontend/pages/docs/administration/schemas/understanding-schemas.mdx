...
[Creating a Schema](../administration/schemas/create-a-schema).
...
See [Schema Migrations](../administration/schemas/schema-migrations) for details.
...
For technical instructions on writing schema JSON, see [Creating a Schema](../administration/schemas/create-a-schema).

## Related pages

- [Creating a Schema](../administration/schemas/create-a-schema) - Step-by-step schema authoring guide
...
- [Managing Review Roles](../administration/review-roles/managing-review-roles) - Creating roles to attach to schemas
