...
If you're new to schemas, read [Understanding Schemas](understanding-schemas) first for a non-technical overview.
...
2. Upload it using the [Upload a Schema](upload-a-schema) page
...
- [Understanding Schemas](understanding-schemas) - Non-technical overview
- [Uploading a Schema](upload-a-schema) - How to upload your schema to Bailo
