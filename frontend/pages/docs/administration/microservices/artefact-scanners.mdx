...
of artefacts being uploaded with potentially malicious contents. We provide two artefact scanners by default:
...
[custom connector](https://github.com/gchq/Bailo/blob/main/backend/src/connectors/artefactScanning/clamAv.ts) to
communicate with ClamAV using [clamscan](https://www.npmjs.com/package/clamscan).

> ClamAV® is an open-source antivirus engine for detecting trojans, viruses, malware & other malicious threats.

## ModelScan

We have a [dockerised REST API](https://github.com/gchq/Bailo/tree/main/lib/artefactscan_api) to programmatically
interact with ModelScan via a
[custom connector](https://github.com/gchq/Bailo/blob/main/backend/src/connectors/fileScanning/artefactScan.ts).
...
| ------------------------------------------------- | ------------------------------------------------------------------------------------- | ------ |
| `connectors.artefactScanners.kinds`               | A list of the file scanner names to enable                                            | `[]`   |
