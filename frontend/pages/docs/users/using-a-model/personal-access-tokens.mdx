...
be asked to specify which models the token can be used with and the actions it is allowed to be used for.
...
Fill out the form and click "Generate Token" to generate your token:
