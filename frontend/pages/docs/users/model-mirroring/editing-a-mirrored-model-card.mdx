...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image alt='mirrored model card with read-only source content' src={editMirroredModel} />
</Box>
...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image alt='mirrored model additional information form' src={editMirroredModelForm} />
</Box>
...
<Box sx={{ maxWidth: '40%', margin: 'auto' }}>
  <Image alt='mirrored model card showing source and local content' src={editMirroredModelResult} />
</Box>
