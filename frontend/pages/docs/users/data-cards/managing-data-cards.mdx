...
See [Schema Migrations](../administration/schemas/schema-migrations) for further details. Note that changing schemas may
require you to re-enter some information if the new schema has different fields.
...
- [Creating a Data Card](../users/data-cards/creating-a-data-card) - How to create a new data card
- [Roles & Permissions](../reference/roles-and-permissions) - What each role allows
- [Python Client](../users/programmatically-using-bailo/python-client) - Full programmatic access guide
