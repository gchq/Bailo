...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image style={{ width: '100%', height: 'auto' }} alt='model settings deletion section' src={bailoDeleteModel} />
</Box>
...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image style={{ width: '100%', height: 'auto' }} alt='delete model confirmation dialog' src={bailoDeleteConfirm} />
</Box>
