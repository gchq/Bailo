...
Delete a file or folder from the File Management tab using the actions menu:

1. Open the model
2. Navigate to the **Files** tab
3. Navigate to the file or folder you want to delete
4. Open the actions menu (⋮)
5. Select **Delete File** or **Delete folder**

Deleting a folder removes all files within it and any sub-folders.
