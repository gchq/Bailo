...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image style={{ width: '100%', height: 'auto' }} alt='file actions menu with delete option' src={bailoFileMenu} />
</Box>
...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image
    ...
    alt='delete file confirmation dialog showing affected releases'
    src={bailoDeleteFileConfirm}
  />
</Box>
