...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image style={{ width: '100%', height: 'auto' }} alt='generate personal token form' src={createPersonalAccessToken} />
</Box>
...
- [Authentication](authentication) - Overview of authentication methods
- [Python Client](python-client) - Using tokens with the Python client
