...
Bailo provides an OpenAPI specification for all Bailo endpoints viewable [here](/api/docs/) on a running Bailo instance.
...
- [Authentication](../users/programmatically-using-bailo/authentication) - Setting up API authentication
- [Python Client](../users/programmatically-using-bailo/python-client) - Python wrapper for the API
