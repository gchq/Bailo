...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image
    ...
    alt='open access requests reviews page with a unreviewed request'
    src={bailoAccessRequest}
  />
</Box>
...
- [Requesting Access](../../using-a-model/requesting-access/access-requests) - How users create access requests
