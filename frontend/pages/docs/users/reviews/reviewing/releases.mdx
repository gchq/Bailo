...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image
    ...
    alt='open release reviews page with a list of unreviewed releases'
    src={bailoReviewPage}
  />
</Box>
...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image
    style={{ width: '100%', height: 'auto' }}
    alt='releases page showing release with review banner visually attached'
    src={bailoReview}
  />
</Box>
...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image style={{ width: '100%', height: 'auto' }} alt='release review approval popup' src={bailoReviewForm} />
</Box>
