...
These represent what is displayed for the model in the Marketplace. Public models are available for everyone, whereas
private models will only be visible if you have been given the right permissions in the model settings.
