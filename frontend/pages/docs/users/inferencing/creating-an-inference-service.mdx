...
- A container (Docker) image pushed to the model's registry (see [Uploading Images](../models/uploading-images))
...
- [Managing Inference Services](managing-inference-services) - Updating and deleting services
- [Uploading Images](../models/uploading-images) - How to push container images
- [Requesting Access](../using-a-model/requesting-access/access-requests) - How to request access to a model
