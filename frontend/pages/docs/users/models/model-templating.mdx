...
1. Create a new model (see [Creating a Model](../users/models/creating-a-model))
...
- [Python Client](../users/programmatically-using-bailo/python-client) - Programmatic workflows
