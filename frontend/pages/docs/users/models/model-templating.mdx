...
1. Create a new model (see [Creating a Model](creating-a-model))
...
- [Creating a Model](creating-a-model) - Standard model creation
- [Python Client](../programmatically-using-bailo/python-client) - Programmatic workflows
