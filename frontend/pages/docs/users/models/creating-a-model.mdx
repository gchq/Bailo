...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image style={{ width: '100%', height: 'auto' }} alt='view of the marketplace' src={bailoMarketIcon} />
</Box>
...
1. [Fill in the model card](model-card/model-card) - document your model
...
- [Model Card](model-card/model-card) - Filling in the model card and configuring access
