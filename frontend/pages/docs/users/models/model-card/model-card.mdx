...
<Box sx={{ maxWidth: '75%' }}>
  <Image
    ...
    alt='updating a model card for production using required fields'
    src={bailoUpdateModelCardForProduction}
  />
</Box>
...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image style={{ width: '100%', height: 'auto' }} alt='selecting user model roles' src={bailoModelAccess} />
</Box>
...
- [Creating a Model](../creating-a-model) - Setting up a new model
- [Creating a Release](../creating-a-release) - Versioning your model
