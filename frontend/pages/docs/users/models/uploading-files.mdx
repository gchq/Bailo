...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image style={{ width: '100%', height: 'auto' }} alt='view of files being uploaded' src={bailoUploadFile} />
</Box>
...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image
    ...
    alt='new release form with file attached'
    src={bailoUploadFileRelease}
  />
</Box>
...
<Box sx={{ maxWidth: '75%', margin: 'auto' }}>
  <Image
    style={{ width: '100%', height: 'auto' }}
    alt='view of existing release with edit release button'
    src={bailoUploadedFileRelease}
  />
</Box>
