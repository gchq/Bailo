...
import { getModelTransferSchema } from '../../../src/routes/v2/modelTransfer/getTransferStatus.js'
import { createFixture, testGet } from '../../testUtils/routes.js'

vi.mock('../../../src/connectors/audit/index.js')

describe('routes > modelTransfer > getModelTransferStatus', () => {
  test('200 > ok', async () => {
    ...
    const res = await testGet(`/api/v2/transfer/${fixture.params.transferId}/status`)
