...
import { parseModelCard, parseRelease } from '../entityParsers.js'
import { parseFile } from '../entityParsers.js'
...
export class DocumentsImporter extends BaseImporter {
  declare protected readonly metadata: DocumentsMirrorMetadata
