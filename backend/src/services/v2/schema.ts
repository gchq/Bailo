...
import modelSchema from '../../scripts/example_schemas/minimal_upload_schema.json' assert { type: 'json' }
...
export async function addDefaultSchemas() {
  const uploadSchemaDoc = new Schema({
    ...
    description:
      "This schema complies with all requirements laid out in the [AI Policy](https://example.com) as well as best practices recommended by 'Science and Research'.\n\nIf you're unsure which model card to pick, you'll likely want this one!",
