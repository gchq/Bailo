    ...
    modelCards: [
      {
        ...
        description:
          "This is the latest version of the default model card for most users. It complies with all requirements laid out in the [AI Policy](https://example.com) as well as best practices recommended by 'Science and Research'.\n\nIf you're unsure which model card to pick, you'll likely want this one!",
