...
#### Minimal local.yaml for OpenShift Dev Environment (Clamav and ModelScan are optional)
...
5. eks-persistent-storage https://repost.aws/knowledge-center/eks-persistent-storage # Helm storage.yaml is set for provisioner: ebs.csi.aws.com
6. ebs-csi https://docs.aws.amazon.com/eks/latest/userguide/ebs-csi.html

#### Minimal local.yaml for AWS EKS Dev Environment (Clamav and ModelScan are optional)
